...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		defaultList = [ //Name - Icon name - Description - Link - BG Color
			['Iron Lung Mod Team'],
			['LORAY',				'loray',			'Lead Director/Composer/Coder/Animator/Lixian\'s Sprites',		'https://www.youtube.com/@LORAY_',	'00FF55'],
			...
			['the yornder303',		'yornder',			'V3 Thumbnail Artist',									        'https://twitter.com/yornder303',	'FFFF00'],
			['Call',				'call',				'V3 Composer',									        		'https://www.youtube.com/@Call_-_',	'38109E'],
			['KOSE',				'Kose',				'V3 Composer',									        		'https://www.youtube.com/@kosejumpscare',	'CC31C9'],
			[''],
